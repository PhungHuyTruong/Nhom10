...
CREATE TABLE LichHoc (
    ...
    CONSTRAINT FK_LichHoc_NXCH FOREIGN KEY (IdNXCH) REFERENCES KHNXCaHoc(IdKHCH),
...
CREATE TABLE LichGiangDay (
    ...
    CONSTRAINT FK_LGD_NXCH FOREIGN KEY (IdNXCH) REFERENCES KHNXCaHoc(IdNXHC),
...
CREATE TABLE KHNXCaHoc (
	...
	CONSTRAINT FK_KHNXCaHoc_KHNhomXuong FOREIGN KEY (IdKHNX) REFERENCES KeHoachNhomXuong(IdKHNX),
...
CREATE TABLE LichSuDiemDanh (
    ...
    CONSTRAINT FK_LSDD_NXCH FOREIGN KEY (IdNXCH) REFERENCES KHNXCaHoc(IdNXHC)
);
